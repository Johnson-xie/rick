"""
Django settings for sat_hello project.
...
SITE_CONFIGS = {
    ...
    # 站点底部footer配置
    'Footer': {
        'Email': 'johnson19921005@163.com',  # 邮箱
        'Leetcode-cn': 'https://leetcode-cn.com/johnson_xie/',  # leetcode
    ...
    'Music': {
        ...
        'home': 'https://music.163.com/#/user/home?id=438569564',  # 用户主页，点击会跳转到你的主页
        'server': 'netease',  # netease（网易云音乐）tencent（QQ音乐） xiami（虾米） kugou（酷狗）
        'mode': 'random',  # random （随机） single （单曲） circulation （列表循环） order （列表）
        'type': 'playlist',  # song （单曲） album （专辑） playlist （歌单） search （搜索）
        'id': '630998799',  # 播放歌单id，获取方法自行百度。比如我的id就是链接后面的id，https://music.163.com/#/playlist?id=2700450552
